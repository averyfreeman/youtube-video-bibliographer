...
The gate covers phrase rejection, intro filtering, project configuration, timestamp cursors, ETA/cap state, storyboard tile selection, Markdown headers/body, mocked asynchronous polling, Mermaid fallback, lazy thumbnails, exact Markdown downloads, and the production build.
